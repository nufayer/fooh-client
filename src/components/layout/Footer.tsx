...
const socialLinks = [
  { icon: GithubIcon, href: "https://github.com/nufayer", label: "GitHub" },
  { icon: LinkedinIcon, href: "https://www.linkedin.com/in/nufayer-mahmud009", label: "LinkedIn" },
  { icon: FacebookIcon, href: "https://www.facebook.com/nufayer.mahmud", label: "Facebook" },
];
